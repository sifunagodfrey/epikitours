...
$metaDescription = "View and manage all payments in the EpikiTours admin panel.";
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="<?= BASE_URL ?>payments/add.php" class="btn btn-primary">
        ...
        <div class="table-responsive">
            <table class="table table-bordered align-middle table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="8" class="text-center">Payment data will appear here...</td>
                    </tr>
                </tbody>
            </table>
        </div>
